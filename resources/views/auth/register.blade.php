...
<div class="container">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="container mb">
                        <div class="form-group input-group-sm">
                            <label style="font-size: 13px" for="name">{{ __('Name') }}</label>
                            ...
                            @enderror
                            <label style="font-size: 13px" for="email">{{ __('Email Address') }}</label>
                    ...
                    <div class="container mb-3">
                        <div class="form-group input-group-sm">
                            <label style="font-size: 13px" for="password">{{ __('Password') }}</label>
                            ...
                            @enderror
                            <label style="font-size: 13px" for="password-confirm">{{ __('Confirm Password') }}</label>
                    ...
                    <div class="container justify-content-center">
                        <div class="form-group input-group-sm">
                                ...
                                <p class="text-muted d-flex justify-content-center mt-1">or</p>
                        </div>
                    </div>
                    <div class="container justify-content-center">
                        <div class="form-group input-group-sm">
    ...
    <div class="container d-flex justify-content-center mb-5" >
        ...
        <a href="{{ route('login') }}" role="button" class="btn btn-outline-secondary btn-sm">Login</a>
    </div>
</div>
